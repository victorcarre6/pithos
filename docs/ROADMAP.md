...
- [TODO] 01 — benchmark multi-modèles Ollama/Pi avec TUI, dashboard et sélection finale.
- [TODO] 02 — valider les effets réels de Pi avec la baseline.
- [DONE] 03 — continuité atomique ; test réel inter-session différé.
...
- [TODO] 11 — bootstrap de campagne après sélection du modèle et validation du socle.
