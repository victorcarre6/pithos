...
`harness/ground_truth/.pi/extensions/pithos-telegram.ts` fournit le custom tool `pithos_notify`. Le modèle choisit le
type et le texte, tandis que l'extension construit elle-même le `request_id` et n'accepte aucun destinataire.
